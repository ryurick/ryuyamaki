...
export const HERO = {
  eyebrow: "【中小企業・個人事業主向け】",
  title: "面倒な作業をAIで減らします。",
  sub: "まず30分の無料診断で現状を見せてもらい、減らせそうな作業があれば仕組みを作って引き渡します。業種は問いません。",
  cta: "無料30分診断を予約",
} as const;
...
export const PAIN_CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      ...
      "受注のたびに、MakeShopや楽天などの管理画面とExcelを行き来している",
...
export const SERVICES_NOTE =
  "こうした作業をAIやITの力で減らせます。（無料診断で一緒に決めていきましょう）";
...
export const WHY_ME = {
  ...
  items: [
    {
      head: "全部、本人がやります",
      text: "相談から構築、渡したあとの調整まで、同じ人間が担当します。話が早いです。",
    },
    {
      head: "直して、すぐ返す",
      text: "会社の見積もりや稟議を待たないので、小さな修正はその日のうちに返せることも多いです。",
    },
    {
      head: "会社に頼むより安い",
      text: "営業や事務所の経費が乗らない分、費用を抑えられます。",
    },
  ],
} as const;
...
export const MONITOR = {
  banner: "モニター募集中（先着2社）：事例掲載OKの方は構築費半額 →",
  label: "モニター募集（先着2社）",
